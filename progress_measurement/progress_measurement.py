...
class progress_measurement(osv.osv):
    ...
    _constraints = [
        (_check_is_value_less_than_max, 'Error! The value must be less than the maximum permitted '
                                        'defined in the progress measurement type', ['value', 'progress_type']),
        (_check_is_valid_precision, 'Error! The value is entered in a higher precision to that'
                                    'defined in the progress measurement type', ['value', 'progress_type']),
    ...
    def create(self, cr, uid, vals, *args, **kwargs):
        ...
        return super(progress_measurement, self).create(cr, uid, vals, *args, **kwargs)
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        return super(progress_measurement, self).write(cr, uid, ids, vals, context=context)
