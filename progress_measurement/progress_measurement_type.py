...
class progress_measurement_type(osv.osv):
    ...
    _constraints = [
        (_check_default_max_value, 'Error! The maximum value must be greater than 0', ['default_max_value']),
        (_check_is_percent_default_max_value, 'Error! The maximum percentage must not exceed 100',
         ['is_percent', 'default_max_value']),
        (_check_precision, 'Error! The precision value must be greater than 0',
         ['precision']),
        (_check_is_default_max_value_greater_than_precision,
         'Error! Default maximum value must be greater than precision value',
